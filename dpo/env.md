...
# mamba install uv -c conda-forge -y # Install uv INTO the rna environment
...
uv pip install wandb gdown pyyaml ipdb python-dotenv tqdm cpdb-protein torchmetrics einops ml_collections mdanalysis MDAnalysisTests draw_rna arnie
